      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div>
              <label className="text-slate-500">Time Left Site</label>
            ...
            <div>
              <label className="text-slate-500">Time Returned</label>
            ...
            <div>
              <label className="text-slate-500">Time Finished</label>
